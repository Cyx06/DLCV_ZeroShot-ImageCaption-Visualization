...
#             if pre_image_id != val['image_id']:
#                 pre_image_id = val['image_id']
#                 count += 1
#             # print(ann['images'][count]['file_name'])
#             self.annot.append((str(ann['images'][count]['file_name']), val['caption']))
#         # self.annot = {}
#         # for val in ann['annotations']:
#         #     if pre_image_id != val['image_id']:
#         #         pre_image_id = val['image_id']
#         #         count += 1
#         #     print(ann['images'][count]['file_name'])
#         #     if ann['images'][count]['file_name'] not in self.annot:
#         #         self.annot[ann['images'][count]['file_name']] = [val['caption']]
#         #     else:
#         #         self.annot[ann['images'][count]['file_name']].append(val['caption'])
#         if mode == 'validation':
...
#
#     def _process(self, image_id, ann):

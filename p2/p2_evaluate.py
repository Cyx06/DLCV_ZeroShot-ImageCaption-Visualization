...
class CLIPScore:
    ...
    def __call__(self, predictions, images_root):
        ...
        for img_name, pred_caption in predictions.items():
            ...
            this_score = self.getCLIPScore(image, pred_caption)
            if this_score < min_score[0]: min_score = [this_score, image_path]
            if this_score > high_score[0]: high_score = [this_score, image_path]
            total_score += this_score
        print(min_score, high_score)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred_file", default="../pred.json", help="Prediction json file")
